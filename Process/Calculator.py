...
class Calculator(object):
	...
	def calculate_percentage(self, corp_name, perc, n):
		...
		print("target price is:%.2f"%(target_price))
		fees = 0
		...
		if int(target_price * n / 100) < 1:
			...
			fees += int(target_price * n / 100) * 5
		profit = (target_price - buyin_price) * n * 100 - fees - tax
...
if __name__ == '__main__':
	...
	while(1):
		try:
			...
			if perc == 'q':
				break
			n = input('Please input how many contracts you will sell:')
			if n == 'q':
				break
